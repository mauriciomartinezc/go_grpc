...
import (
	context "context"
	studentpb "github.com/mauriciomartinezc/go_grpc/studentpb"
...
type TestServiceClient interface {
	...
	SetEnrollmentStudent(ctx context.Context, opts ...grpc.CallOption) (TestService_SetEnrollmentStudentClient, error)
...
func (c *testServiceClient) SetEnrollmentStudent(ctx context.Context, opts ...grpc.CallOption) (TestService_SetEnrollmentStudentClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[1], "/test.TestService/SetEnrollmentStudent", opts...)
	if err != nil {
		return nil, err
	}
	x := &testServiceSetEnrollmentStudentClient{stream}
	return x, nil
}

type TestService_SetEnrollmentStudentClient interface {
	Send(*EnrollmentRequest) error
	CloseAndRecv() (*SetQuestionResponse, error)
	grpc.ClientStream
}

type testServiceSetEnrollmentStudentClient struct {
	grpc.ClientStream
}

func (x *testServiceSetEnrollmentStudentClient) Send(m *EnrollmentRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *testServiceSetEnrollmentStudentClient) CloseAndRecv() (*SetQuestionResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(SetQuestionResponse)
...
type TestServiceServer interface {
	...
	SetEnrollmentStudent(TestService_SetEnrollmentStudentServer) error
...
func (UnimplementedTestServiceServer) SetEnrollmentStudent(TestService_SetEnrollmentStudentServer) error {
	return status.Errorf(codes.Unimplemented, "method SetEnrollmentStudent not implemented")
}
...
func _TestService_SetEnrollmentStudent_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TestServiceServer).SetEnrollmentStudent(&testServiceSetEnrollmentStudentServer{stream})
}

type TestService_SetEnrollmentStudentServer interface {
	SendAndClose(*SetQuestionResponse) error
	Recv() (*EnrollmentRequest, error)
	grpc.ServerStream
}

type testServiceSetEnrollmentStudentServer struct {
	grpc.ServerStream
}

func (x *testServiceSetEnrollmentStudentServer) SendAndClose(m *SetQuestionResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *testServiceSetEnrollmentStudentServer) Recv() (*EnrollmentRequest, error) {
...
var TestService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SetEnrollmentStudent",
			Handler:       _TestService_SetEnrollmentStudent_Handler,
			ClientStreams: true,
		},
		{
